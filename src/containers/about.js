...
import house_1 from '../assets/images/house_1.jpg';
const About = () => {
    ...
    useEffect(()=>{
        ...
        axios.get(`http://127.0.0.1:8000/api/realtors/topseller/`, config)
        .then(res =>(
            ...
            <section className='about__info'>
                <div className='row'>
                    <div className='col-3-of-4'>
                        ...
                        <div className='about__display'>
                            <img className='about__display__image' src={house_1} alt='' />
                        </div>
                        <p className='about__paragraph'>
